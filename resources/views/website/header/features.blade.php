    ...
    <div class="container">
        ...
        <section class="feature-grid">
            <article class="feature">
                <img src="{{asset('')}}admin-assets/image/Technical-Innovation.png" alt="Tech Innovations" height="500px" >
            ...
            <article class="feature">
                <img src="{{asset('')}}admin-assets/image/climate.jpg" alt="Climate Change" height="500px">
            ...
            <article class="feature">
                <img src="{{asset('')}}admin-assets/image/Economics%20and%20Finance.jpg" alt="Economy and Finance" height="500px">
            ...
            <article class="feature">
                <img src="{{asset('')}}admin-assets/image/health.jpg" alt="Health and Wellness" height="500px"  >
